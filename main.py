...
tk.Label(main_frame, text="选择菜单项", font=("NSimSun", 25), bg="#f0f0f0").pack(pady=10)
...
def making_training_page(name_of_file, new = True):
    ...
    tk.Button(training_frame,text="Обновить",**button_config_x,
    ...
    # Кнопка "Назад"
    tk.Button(training_choose_frame,text="Back / 返回",**back_button_config,
